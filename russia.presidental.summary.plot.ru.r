...
col="blue",
lty=3,
main="Официальные результаты выборов президентов РСФСР/РФ\nстрана в целом vs. 14 'честных' регионов", 
xlab="Годы", ylab="Явка / доля голосовавших",
...
axis(1, at=c(1991:2012), tck=-.01, labels=NA)
axis(1, at=c(1991,seq(1996,2012,4)), tck=-.02)
axis(2)
dev.off()
